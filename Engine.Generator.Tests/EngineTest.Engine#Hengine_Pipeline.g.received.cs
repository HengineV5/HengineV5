	...
	public partial class Hengine
	{
		public class GraphicsPipeline
		{
			...
			public void Run<TWorldInterface>(ref EngineContext argEngineContext, HengineEcs ecs, ref TestContext argTestContext)
				where TWorldInterface : IWorld<OpenGLRenderSystem, HengineEcs, TestContext>, IWorld<System2, HengineEcs>, IWorld<System3, HengineEcs>, allows ref struct
			{
				_OpenGLRenderSystem.PreRun();
				TWorldInterface.Loop(_OpenGLRenderSystem, ecs, ref argTestContext);
				TWorldInterface.Loop(_System2, ecs);
				TWorldInterface.Loop(_System3, ecs);
		...
		public class PhysicsPipeline
		{
			...
			public void Run<TWorldInterface>(ref EngineContext argEngineContext, HengineEcs ecs)
				where TWorldInterface : IWorld<System2, HengineEcs>, allows ref struct
			{
