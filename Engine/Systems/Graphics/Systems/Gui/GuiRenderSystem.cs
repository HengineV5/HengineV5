...
namespace Engine
{
	...
	public partial class GuiRenderSystem
	{
		IWindow window;
		...
		GpuSampler sampler;
		MeshBuffer boxBuffer;

		public GuiRenderSystem(GraphicsContext renderContext, IWindow window, IInputHandler inputHandler)
		{
		...
		[SystemUpdate, SystemLayer(0, 2)]
		public void RenderUpdate(ref RenderContext context, ref GuiProperties properties, ref GuiPosition position, ref GuiSize size, ref GuiState guiState, ref TextureAtlasBuffer textureAtlas)
		{
